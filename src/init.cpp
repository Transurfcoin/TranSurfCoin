...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/transurfcoin-project/transurfcoin>";
    const std::string URL_WEBSITE = "<https://transurfcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Transurfcoin version %s\n", FormatFullVersion());
}
