...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s transurfcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  transurfcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded transurfcoin transaction") + "\n" +
              "  transurfcoin-tx [options] -create [commands]   " + _("Create hex-encoded transurfcoin transaction") + "\n" +
              "\n";
