...
#if defined(NDEBUG)
# error "Transurfcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Transurfcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s TSC additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
	...
	if (nHeight == 0)
		...
		nSubsidy = 37500000 * COIN; //Premine
	else
		nSubsidy = 100 * COIN; //Reward
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Transurfcoin: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
